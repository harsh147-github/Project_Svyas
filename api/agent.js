// api/agent.js
// Vercel serverless function that routes to specialized AI agents via Anthropic API
...
- For backends, suggest simple options: Netlify Functions, Supabase, Firebase.
...
- Be specific about timing and channels: "Post on r/SideProject at 9am EST on Tuesday" level specific.
- Help them tell their STORY, not just describe features. "I was a 12th grader who..." > "This app does..."
...
Tone: Like a startup advisor who's launched 10 things and knows exactly what works.`,
  ...
  orchestrator: {
    name: "SUAS Guide",
    emoji: "🌿",
    system: `You are the SUAS Guide — the main AI assistant for the SUAS platform (स्वास — "pure breath"). SUAS helps anyone turn their curiosity into real solutions.
...
- If someone just wants to chat about their problem, that's fine. Not everything needs to go through agents.
...
Tone: Like the wisest, kindest mentor you've ever had — who also gets shit done.`,
  },
};

export default async function handler(req, res) {
  // Basic CORS headers (not strictly needed for same-origin, but safe)
