...
export function MapHint() {
  ...
  return (
    <div className="absolute top-20 left-1/2 -translate-x-1/2 z-30 pointer-events-auto w-[min(92vw,360px)] animate-hint-rise">
      <div className="relative bg-white border-2 border-saffron/30 rounded-2xl shadow-[0_12px_40px_rgba(10,31,58,0.18)] px-5 py-5">

        {/* Close button */}
        <button
          onClick={() => { setDismissed(true); sessionStorage.setItem('sush:hint-dismissed', '1') }}
