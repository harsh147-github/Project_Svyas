...
const CLUSTERS: Cluster[] = [
  ...
  { id: 'd01', ward_id: '4',  issue_tag: 'traffic',     centroid_text: 'East Kharadi EON IT Park bypass merge causing 40-min delays at peak shift change.',          post_count: 29, severity_avg: 4.1, status: 'open', updated_at: '2026-05-01T08:00:00Z' },
  { id: 'd02', ward_id: '4',  issue_tag: 'electricity', centroid_text: 'Kharadi Phase-3 transformer overload — MSEDCL load-shedding across three residential societies.', post_count: 10, severity_avg: 3.0, status: 'open', updated_at: '2026-04-30T10:00:00Z' },
  { id: 'd03', ward_id: '5',  issue_tag: 'water',       centroid_text: 'West Kharadi societies on PMC tail-end — zero pressure by 8am, tankers inadequate.',          post_count: 12, severity_avg: 3.2, status: 'open', updated_at: '2026-04-29T14:00:00Z' },
  { id: 'd04', ward_id: '6',  issue_tag: 'traffic',     centroid_text: 'Ramwadi–Viman Nagar corridor peak clog — Phoenix mall exit traffic backing onto Nagar Road.', post_count: 23, severity_avg: 3.9, status: 'open', updated_at: '2026-05-01T12:00:00Z' },
  { id: 'd05', ward_id: '6',  issue_tag: 'water',       centroid_text: 'Kalyani Nagar Lane 7 building-level supply complaints, possibly old pipeline corrosion.',       post_count: 10, severity_avg: 3.1, status: 'open', updated_at: '2026-04-28T09:00:00Z' },
  { id: 'd06', ward_id: '7',  issue_tag: 'water',       centroid_text: 'Yerwada inner lanes supply gaps post 6pm — tankers called daily by three societies.',           post_count: 14, severity_avg: 3.4, status: 'open', updated_at: '2026-04-30T16:00:00Z' },
  { id: 'd07', ward_id: '7',  issue_tag: 'garbage',     centroid_text: 'Yerwada community-bin overflow at three junctions — RWAs requesting twice-daily PMC lift.',    post_count: 8,  severity_avg: 2.9, status: 'open', updated_at: '2026-04-29T11:00:00Z' },
  { id: 'd08', ward_id: '12', issue_tag: 'traffic',     centroid_text: 'Aundh-Baner link road heavy vehicle bypass clogging Sakal Nagar entry — school hazard.',       post_count: 22, severity_avg: 3.8, status: 'open', updated_at: '2026-05-01T07:00:00Z' },
  { id: 'd09', ward_id: '12', issue_tag: 'electricity', centroid_text: 'Baner–Pashan link load-shedding twice in April — transformer-protection trips suspected.',     post_count: 13, severity_avg: 3.2, status: 'open', updated_at: '2026-04-30T14:00:00Z' },
  { id: 'd10', ward_id: '20', issue_tag: 'traffic',     centroid_text: 'Pune station forecourt — auto and cab encroachment creating permanent bottleneck at north gate.', post_count: 25, severity_avg: 4.0, status: 'open', updated_at: '2026-05-02T08:00:00Z' },
  { id: 'd11', ward_id: '21', issue_tag: 'traffic',     centroid_text: 'Koregaon Park–Mundhwa bridge peak: opposite flows competing, no marshalling from signal side.', post_count: 18, severity_avg: 3.6, status: 'open', updated_at: '2026-04-30T09:00:00Z' },
  { id: 'd12', ward_id: '23', issue_tag: 'traffic',     centroid_text: 'Magarpatta City gate bottleneck during evening peak — office + Hadapsar shoppers compounding.', post_count: 18, severity_avg: 3.6, status: 'open', updated_at: '2026-04-30T18:00:00Z' },
  { id: 'd13', ward_id: '24', issue_tag: 'water',       centroid_text: 'Magarpatta-Sadhana area societies flag erratic supply pressure on weekends.',                  post_count: 9,  severity_avg: 2.8, status: 'open', updated_at: '2026-04-29T10:00:00Z' },
  { id: 'd14', ward_id: '25', issue_tag: 'garbage',     centroid_text: 'Hadapsar Gaothan inner lanes — irregular wet-waste pickup, three overfill sites this fortnight.', post_count: 7, severity_avg: 2.5, status: 'open', updated_at: '2026-04-28T15:00:00Z' },
  { id: 'd15', ward_id: '31', issue_tag: 'traffic',     centroid_text: 'Kothrud Depot junction — bus-rapid lane crossover causes peak gridlock toward Paud Road.',      post_count: 19, severity_avg: 3.7, status: 'open', updated_at: '2026-05-01T08:00:00Z' },
  { id: 'd16', ward_id: '40', issue_tag: 'electricity', centroid_text: 'Bibwewadi–Gangadham streetlights on rotation cycle out — residents flag night-time safety risk.', post_count: 12, severity_avg: 3.4, status: 'open', updated_at: '2026-05-01T19:00:00Z' },
  { id: 'd17', ward_id: '41', issue_tag: 'water',       centroid_text: 'Kondhwa Khurd Mithanagar supply timing erratic — RWA-led documentation effort under way.',       post_count: 13, severity_avg: 3.3, status: 'open', updated_at: '2026-04-30T12:00:00Z' },
  { id: 'd18', ward_id: '44', issue_tag: 'water',       centroid_text: 'Fursungi tail-end supply only 20-minute morning window; residents collecting manually from tanker.', post_count: 13, severity_avg: 3.4, status: 'open', updated_at: '2026-04-29T08:00:00Z' },
  { id: 'd19', ward_id: '48', issue_tag: 'electricity', centroid_text: 'Upper Indiranagar feeder issue — 3 consecutive Monday outages, MSEDCL citing cable age.',         post_count: 12, severity_avg: 3.2, status: 'open', updated_at: '2026-04-30T20:00:00Z' },
  { id: 'd20', ward_id: '50', issue_tag: 'water',       centroid_text: 'Sahakarnagar–Taljai supply variance — morning pressure normal but zero by 10am on hot days.',     post_count: 11, severity_avg: 3.0, status: 'open', updated_at: '2026-04-29T09:00:00Z' },
  { id: 'd21', ward_id: '54', issue_tag: 'garbage',     centroid_text: 'Dhayari Gaothan market strip — vendors spilling organic waste after 8pm, no night-time pickup.',  post_count: 8,  severity_avg: 2.6, status: 'open', updated_at: '2026-04-28T22:00:00Z' },
  { id: 'd22', ward_id: '55', issue_tag: 'electricity', centroid_text: 'Dhankawadi–Ambegaon stretch three streetlight failures, new RWAs not on PMC maintenance list.',   post_count: 9,  severity_avg: 2.8, status: 'open', updated_at: '2026-04-29T20:00:00Z' },
  { id: 'd23', ward_id: '56', issue_tag: 'traffic',     centroid_text: 'Bharati Vidyapeeth junction school-rush choke — no signal, four-way free-for-all every morning.',  post_count: 19, severity_avg: 3.7, status: 'open', updated_at: '2026-05-01T08:00:00Z' },
  { id: 'd24', ward_id: '57', issue_tag: 'water',       centroid_text: 'Sukhsagarnagar supply disruption — pipeline repair left without restoration for 9 days.',          post_count: 16, severity_avg: 3.7, status: 'open', updated_at: '2026-05-02T09:00:00Z' },
  { id: 'd25', ward_id: '58', issue_tag: 'traffic',     centroid_text: 'Katraj Chowk peak congestion — Pune-Satara highway merge vs city traffic, ambulance corridor disruption.', post_count: 26, severity_avg: 4.0, status: 'open', updated_at: '2026-05-01T08:00:00Z' },
  { id: 'd26', ward_id: '58', issue_tag: 'garbage',     centroid_text: 'Katraj-Gokulnagar back lanes — chronic open dumping near BRT corridor, flagged three times in 2026.', post_count: 10, severity_avg: 3.0, status: 'open', updated_at: '2026-04-30T17:00:00Z' },
]
